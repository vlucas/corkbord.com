...
var sources_default = createRoute().get(async (c) => {
  ...
  const content = html`
      <div class="mx-auto max-w-2xl space-y-6">
        ...
        ${placeholder(html`<p class="text-base-content/60">Loading…</p>`, renderSourcesList(c, organizationId))}
      </div>
    `;
          ...
          <li class="content-card shadow-sm">
            <div class="flex flex-row flex-wrap items-center justify-between gap-2">
              <div>
                ...
                ${s.lastFetchedAt ? html`<p class="text-base-content/50 text-xs m-0">
